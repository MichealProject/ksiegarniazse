...
// Admin Panel
// Zmiana kart
function tabSwitch(tabId, buttonId) {
    const tabs = ["books", "author", "categories", "user","supp"];
    const buttons = ["bBooks", "bAuthor", "bCategory", "bUser","bSupp"];
